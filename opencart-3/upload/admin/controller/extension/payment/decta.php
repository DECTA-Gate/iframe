...
class ControllerExtensionPaymentDecta extends Controller {
  ...
  public function index() {
    ...
    if (!$this->config->get('payment_decta_iframe') && $this->config->get('payment_decta_iframe')) {
      $this->model_setting_setting->editSettingValue('payment_decta', 'payment_decta_iframe', $this->config->get('payment_decta_iframe'));
      $setting_edited = true;
    }
